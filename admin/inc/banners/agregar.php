...
if (isset($_POST["agregar"])) {
    ...
    if (isset($_FILES['files'])) {
        $imagen->resizeImagesWithLanguage($cod, $_FILES['files'], "../assets/archivos", "../assets/archivos/recortadas", $array["titulo"], $idiomasInputPost);
    }
        ...
        <div class="card-content">
            <div class="card-body">
                ...
                <form method="post" class="row" enctype="multipart/form-data">
                    ...
                    <label class=" col-md-12">Link mostrar(<input type="checkbox" id="chli" name="link_on" value="1">):<br />

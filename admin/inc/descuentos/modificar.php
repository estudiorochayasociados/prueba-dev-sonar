...
$productosSavedArrayJson = json_encode($productos->viewSimple($productosDescuentoCod));

//categorias descuento
$categoriasDescuentodCod = explode(',', $data['data']['categorias_cod']);
$categoriasSavedArrayJson = json_encode($categorias->listForManyCods($categoriasDescuentodCod, $idioma));

//subcategorias descuento
$subcategoriasDescuentoCod = explode(',', $data['data']['subcategorias_cod']);
$subcategoriasSavedArrayJson = json_encode($categorias->listSubcategoriesForManyCods($subcategoriasDescuentoCod, $idioma));

//lista de categorias y subcategorias
$categoriasArray = $categorias->list(["area = 'productos'"], "", "", $idioma);
$subcategoriasArray = [];

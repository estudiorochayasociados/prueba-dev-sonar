        ...
        <div class="card-content">
            <div class="card-body">
                <form method="post" id="form-productos_relacionados" class="row" enctype="multipart/form-data">
                    <label class="col-md-3">Titulo de la relacion
                        <label class="col-md-12">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1"><b>T</b></span>
                                </div>
                                <input name="titulo" type="text" class="titulo" require>
                            </div>
                        </label>
                    </label>
                    ...
                    <div class="col-md-12 mt-20">
                        <input type="submit" class="btn btn-primary btn-block" id="agregar" name="agregar" value="Crear Relacion" />
                    </div>
                </form>
            </div>
        </div>

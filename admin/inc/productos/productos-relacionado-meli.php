            ...
            <tbody>
                ...
                ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Eliminar" href="<?= URL_ADMIN ?>/index.php?op=productos&accion=productos-relacionado-meli&borrar=<?= $producto_["code"] ?>">

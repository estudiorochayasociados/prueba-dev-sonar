...
if (isset($_POST["p1-guardar"])) {
    ...
    if ($error) {
        $funciones->headerMove(URL_ADMIN . '/index.php?op=configuracion&accion=modificar&tab=pagos-tab');
    } else {
...
<div>
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="post" class="row" action="<?= URL_ADMIN ?>/index.php?op=configuracion&accion=modificar&tab=pagos-tab">
                <div class="col-md-3">

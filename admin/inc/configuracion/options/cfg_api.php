...
if (isset($_POST["agregar-api-ml"])) {
    ...
    if ($error) {
        $funciones->headerMove(URL_ADMIN . '/index.php?op=configuracion&accion=modificar&tab=api-tab');
    } else {
...
<div id="accordion">
    <div class="card mt-5">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
                <form method="post" action="<?= URL_ADMIN ?>/index.php?op=configuracion&accion=modificar&tab=api-tab">
                    <div class="row">
            ...
            <div class="card-body">
                <form method="post" action="<?= URL_ADMIN ?>/index.php?op=configuracion&accion=modificar&tab=api-tab">
                    <div class="row">
                        ...
                        <label class="col-md-4" style="margin-top:27px">

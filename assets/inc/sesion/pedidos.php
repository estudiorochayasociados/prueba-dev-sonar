                    ...
                    <div class="panel-heading boton-cuenta bold" role="tab" id="heading" style="padding: 10px;background: #8c8c8c;color: #fff;">
                        <div class="row pedido-centro text-uppercase">
                            ...
                            <div class="col-md-3 dis pedido-right">
                                <div class='label label-default '><?= $_SESSION["lang-txt"]["pedidos"]["estado"] ?>: <?= $value["status_text"] ?></div>
                            </div>
                        </div>
                    </div>
                </a>
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach ($value['detail'] as $value2) { ?>
                                            <?php if ($value2['cod'] == $value['data']["cod"]) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <price class="hidden">$<?= $value2["precio"] * $value2["cantidad"] ?> </price>
                                                    </td>
                                        ...
                                        <tr>
                                            <td>
                                                <price class="hidden"><b>TOTAL DE LA COMPRA</b></price>
                                            </td>
                                            <td class="hidden-xs hidden-sm"></td>
                                            <td class="hidden-xs hidden-sm"></td>
                                            <td>
                                                <price class="hidden"><b>$<?= $precioTotal ?></b></price>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

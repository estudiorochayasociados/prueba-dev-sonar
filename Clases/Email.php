...
class Email
{
    ...
    public function emailEnviar()
    {
        ...
        $mensaje = '<body style="background: #fff ;margin:0;padding:0"><div style="background: #fff;width:700px;margin:auto;padding:20px"><div><br/><img src="' . LOGO . '" width="200"/><br/><hr/></div>' . $this->mensaje . '<br/></div></body>';

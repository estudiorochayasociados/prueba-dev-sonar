...
class Hubspot
{
    ...
    public function __construct()
    {
        ...
        $this->configData = $this->config->viewMarketing();
    }
    ...
    {
        $url = 'https://api.hubapi.com/contacts/v1/contact?hapikey=' . $this->configData['data']['hubspot'];
        $data_ = array(
            'properties' => array(
                array(
                    'property' => 'email',
    ...
    {
        $url = 'https://api.hubapi.com/contacts/v1/contact/vid/' . $this->vid . '/profile?hapikey=' . $this->configData['data']['hubspot'];
        $data_ = array(
            'properties' => array(
                array(
                    'property' => 'email',
    ...
    {
        $url = 'https://api.hubapi.com/contacts/v1/contact/email/' . $this->email . '/profile?hapikey=' . $this->configData['data']['hubspot'];
    ...
    {
        $url = 'https://api.hubapi.com/deals/v1/deal?hapikey=' . $this->configData['data']['hubspot'];
        $data_ = array(
            'associations' => array(
    ...
    {
        $url = 'https://api.hubapi.com/deals/v1/deal/' . $this->deal . '?hapikey=' . $this->configData['data']['hubspot'];
        $data_ = array(
            'properties' => array(
                array(
                    'name' => 'dealstage',
